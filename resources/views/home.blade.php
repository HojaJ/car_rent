        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex flex-col justify-center md:w-3/5 mx-12 md:ms-20 md:mx-0">
                    <h1 class="md:text-start text-center font-car font-bold text-gray-900 mb-8 md:text-5xl text-4xl">
                        <span class="text-pr-400">@lang('EASY AND FAST WAY TO RENT YOUR CAR')</span>
                    </h1>
                    <div class="md:w-3/5 md:hidden">
                        <img loading="lazy" src="/images/home car.png" alt="@lang('home car')">
                    </div>
                    <p class="text-justify md:mx-0 mx-8">
                        @lang('Whether you\'re planning a weekend getaway or a cross-country adventure, we\'ve got you covered. With our wide selection of vehicles and convenient booking system, renting a car has never been this effortless.')
                    </p>
                    <div class="flex justify-center md:justify-start mt-12 me-12 md:-ms-12">
                        <a href="/cars">
                            <button class="bg-pr-400 p-2 border-2 border-white rounded-md text-white hover:bg-pr-500  md:me-12 md:mx-12 mx-7 font-bold">
                                @lang('CARS')
                            </button>
                        </a>
                        <a href="/contact_us">
                            <button class="border-2 border-pr-400 text-black p-2 rounded-md hover:bg-sec-400">
                                @lang('CONTACT US')
                            </button>
                        </a>
                    </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                <div class="flex align-middle justify-center">
                    ...
                    <p class="my-2 mx-8  p-2 font-car font-bold text-pr-400 text-lg ">{{ __('CARS') }}</p>
                    <hr class=" mt-8 h-0.5 w-2/5 bg-pr-500">
                    <hr>
                </div>
                <div class="   md:mr-16 mr-4 mb-4 flex justify-end">
                    <a href="/cars">
                        <button
                                class="border-2 border-pr-400 text-black  p-1 rounded-md hover:bg-pr-400 hover:text-white">{{ __('ALl See') }}</button>
                    </a>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl"
                           href="{{ route('car.reservation', ['car' => $car->id]) }}">
                            ...
                            <span
                                    class="absolute top-0 left-0 m-2 rounded-full bg-pr-400 px-2 pb-1 text-center text-sm font-medium text-white">{{ $car->reduce }}
                                %
                                {{ __("OFF") }}</span>
                        </a>
            ...
            <div class="mx-auto max-w-screen-xl ">
                ...
                <div
                    ...
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Customer Support') }}</h3>
                            <p class="font-car text-gray-700 text-sm ">{{ __('Our dedicated team is here to provide exceptional customer support whenever you need it.') }}</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Super Cars') }}</h3>
                            <p class="font-car text-gray-700 text-sm "> {{ __('Experience the thrill of driving our top-of-the-line supercars that are sure to leave a lasting impression.') }}</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Free Cancelation') }}') }}</h3>
                            <p class="font-car text-gray-700 text-sm "> {{ __('Enjoy the flexibility of free cancellation, giving you peace of mind in case your plans change.') }}</p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Best Price') }}</h3>
                            <p class="font-car text-gray-700 text-sm ">{{ __('We guarantee the best prices for our rental cars, ensuring you get the most value for your money.') }}
                            </p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Easy Process') }}</h3>
                            <p class="font-car text-gray-700 text-sm ">{{ __('Our streamlined process makes renting a car quick and effortless, saving you time and hassle.') }}
                            </p>
                        </div>
                    </div>
                    <div class="flex justify-center align-middle ">
                        ...
                        <div>
                            <h3 class="font-car font-bold text-gray-900 text-2xl">{{ __('Digital services') }}</h3>
                            <p class="font-car text-gray-700 text-sm ">{{ __('Take advantage of our convenient digital services, making your car rental experience even more convenient and efficient.') }}
                            </p>
                        </div>
                    </div>
