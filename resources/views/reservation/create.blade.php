        ...
        <div class="flex justify-between md:flex-row flex-col ">
            ...
            <div class="md:w-2/3  md:border-r border-gray-800 p-2">
                ...
                <div class=" flex items-end mt-8 ms-4">
                    <h3 class="font-car text-gray-500 text-2xl">{{ __('Price') }}</h3>
                    <p>
                        <span
                    ...
                    <form id="reservation_form" action="{{ route('car.reservationStore', ['car' => $car->id]) }}"
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                <label for="full-name" class="block text-sm font-medium leading-6 text-gray-900">{{ __('Name') }}</label>
                                <div class="mt-2">
                                    <input type="text" name="full-name" id="full-name" value="{{ $user->name }}" required
                            ...
                            <div class="sm:col-span-3">
                                <label for="start_date" class="block text-sm font-medium leading-6 text-gray-900">{{ __('Start Time') }}
                                </label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="end_date" class="block text-sm font-medium leading-6 text-gray-900">{{__('Finish Time')}}
                                </label>
                                <div class="mt-2">
                        ...
                        <div class="mt-12 md:block hidden  ">
                            <button type="submit"
                                class="text-white bg-pr-400 p-3 w-full rounded-lg font-bold hover:bg-black shadow-xl hover:shadow-none ">{{ __('Order Now') }}</button>
                        </div>
                    </form>
                </div>
